...
public class OtogiSprite extends MobSprite {
    ...
    public void onComplete( Animation anim ) {
        if (anim == zap) {
            ...
            ((MissileSprite)parent.recycle( MissileSprite.class )).
                    reset( this, cellToAttack, new OtogiShot(), new Callback() {
    ...
    public class OtogiShot extends Item {
        {
