...
public class LightSmokeParticle extends PixelParticle {

	public static final Factory FACTORY = new Factory() {
		@Override
		public void emit( Emitter emitter, int index, float x, float y ) {
			((LightSmokeParticle)emitter.recycle( LightSmokeParticle.class )).reset( x, y );
		}
	};
	...
	public static final Factory SPEW = new Factory() {
		@Override
		public void emit( Emitter emitter, int index, float x, float y ) {
			((LightSmokeParticle)emitter.recycle( LightSmokeParticle.class )).resetSpew( x, y );
		}
	};

	public LightSmokeParticle() {
		super();
