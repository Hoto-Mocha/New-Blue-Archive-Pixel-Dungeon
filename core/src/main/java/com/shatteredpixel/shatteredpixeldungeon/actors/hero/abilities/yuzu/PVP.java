...
public class PVP extends ArmorAbility {
    ...
    public float chargeUse( Hero hero ) {
        ...
        if (hero.buff(EliminationMatchTracker.class) != null){
            ...
            chargeUse *= Math.pow(0.84, hero.pointsInTalent(Talent.YUZU_ARMOR1_3));
        }
        return chargeUse;
    }
    ...
    protected void activate(ClassArmor armor, Hero hero, Integer target) {
        ...
        if (hero.hasTalent(Talent.YUZU_ARMOR1_1)) {
            float evasionChance = 0.5f*hero.pointsInTalent(Talent.YUZU_ARMOR1_1);
            int evasion = 0;
            evasion = (int)evasionChance;
            if (Random.Float() < evasionChance % 1f) evasion++;

            Buff.affect(hero, YuzuStatus.UZQMode.class).set(evasion);
        }
        ...
        public void detach() {
            ...
            if (target != Dungeon.hero){
                if (!target.isAlive() || target.alignment == Dungeon.hero.alignment){
                    ...
                    if (Dungeon.hero.hasTalent(Talent.YUZU_ARMOR1_2)){
                        ...
                        hpToHeal = (int)Math.round(hpToHeal * (1f - Math.pow(0.707f, Dungeon.hero.pointsInTalent(Talent.YUZU_ARMOR1_2))));
                        hpToHeal += 5*Dungeon.hero.pointsInTalent(Talent.YUZU_ARMOR1_2);
                ...
                if (Dungeon.hero.isAlive()) {
                    ...
                    if (Dungeon.hero.hasTalent(Talent.YUZU_ARMOR1_3)){
