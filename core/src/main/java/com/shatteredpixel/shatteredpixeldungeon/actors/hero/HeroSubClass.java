...
public enum HeroSubClass {
	...
	BATTERY_CHARGE(HeroIcon.BATTERY_CHARGE),

	SHOOT_ALL(HeroIcon.SHOOT_ALL),
	SPREAD_SHOT(HeroIcon.SPREAD_SHOT),

	RABBIT_SQUAD(HeroIcon.RABBIT_SQUAD),
	SUPPORT_DRONE(HeroIcon.SUPPORT_DRONE),

	SHIELD_BASH(HeroIcon.SHIELD_BASH),
	SWIFT_MOVEMENT(HeroIcon.SWIFT_MOVEMENT),

	PROFESSIONAL_RIDING(HeroIcon.PROFESSIONAL_RIDING),
	BANK_ROBBER(HeroIcon.BANK_ROBBER),

	DOUBLE_BARREL(HeroIcon.DOUBLE_BARREL),
	CONVERSATION(HeroIcon.CONVERSATION),

	TELESCOPE(HeroIcon.TELESCOPE),
	CAMOUFLAGE(HeroIcon.CAMOUFLAGE),

	NEO_AVANT_GARDE(HeroIcon.NEO_AVANT_GARDE),
	WALLET_WARRIOR(HeroIcon.WALLET_WARRIOR),
