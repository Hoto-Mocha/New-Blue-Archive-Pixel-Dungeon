...
public class BuyDropMulti extends YuzuShopContent {
    ...
    public void onSelect(Hero hero) {
        Buff.affect(hero, YuzuStatus.class).buyStat(YuzuStatus.DROP_MULTI);
    ...
    public boolean canSelect(Hero hero) {
        ...
        else return super.canSelect(hero) && YuzuStatus.yuzuDropMulti(hero)-1 < YuzuStatus.DROP_MULTI_INCREMENT*YuzuStatus.MAX_LEVEL;
    }

    @Override
    public String shortDesc() {
        return Messages.get(this, "short_desc", Messages.decimalFormat("#", 100*YuzuStatus.DROP_MULTI_INCREMENT))
                + ".\n" + Messages.get(this, "credit_cost", creditUse(Dungeon.hero));
    }

    public String desc(){
        return Messages.get(this, "desc",
                Messages.decimalFormat("#", 100*YuzuStatus.DROP_MULTI_INCREMENT),
                Messages.decimalFormat("#", 100*YuzuStatus.DROP_MULTI_INCREMENT*YuzuStatus.MAX_LEVEL),
