...
public class BuyCritChance extends YuzuShopContent {
    ...
    public boolean canSelect(Hero hero) {
        ...
        else return super.canSelect(hero) && YuzuStatus.yuzuCritChance(hero)-YuzuStatus.yuzuBaseCritChance(hero) < YuzuStatus.CRIT_CHANCE_INCREMENT*YuzuStatus.MAX_LEVEL;
    }
