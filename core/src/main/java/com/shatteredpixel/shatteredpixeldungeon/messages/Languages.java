...
public enum Languages {
	...
	CHI_SMPL("简体中文",     "zh", Status.X_UNFINISH, new String[]{""}, new String[]{"SPD's translators credit"}),
	...
	INDONESIAN("indonesia", "in", Status.X_UNFINISH, new String[]{""}, new String[]{"SPD's translators credit"}),
	...
	SWEDISH("svenska",      "sv", Status.X_UNFINISH, new String[]{""}, new String[]{"SPD's translators credit"}),
