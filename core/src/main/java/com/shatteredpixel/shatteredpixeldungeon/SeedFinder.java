...
//		GamesInProgress.selectedClass = HeroClass.WARRIOR;
		Dungeon.init();
		StringBuilder result = new StringBuilder(Messages.get(this, "result", Messages.get(HeroClass.class, GamesInProgress.selectedClass.name()), DungeonSeed.convertToCode(Dungeon.seed), Dungeon.seed)+":\n\n");
